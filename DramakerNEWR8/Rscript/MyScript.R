...
x1=read.csv("D:/BigData_Document/Java_Doc/Dramaker/DramakerNEWR8/Rscript/catetable.csv")
yoyo=read.csv("D:/BigData_Document/Java_Doc/Dramaker/DramakerNEWR8/Rscript/yoyo.csv")
x1=na.exclude(x1)
